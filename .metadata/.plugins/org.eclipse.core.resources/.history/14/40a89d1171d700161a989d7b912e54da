...
public static void main(String[] args) {
		...
		while (opt!=8){
			...
			if (opt==4){
				/*Valorar ejercicio hecho: En esta opción evaluaremos el ejercicio semanal con una
				valoración. Si el número de horas de ejercicio durante toda la semana es superior a 7, y
				además, todos los días se han hecho al menos 45 minutos de ejercicio, la valoración será
				positiva, en caso contrario, será negativa. Esta información se deberá mostrar con un
