...
public class Pruebas {
	public static void main(String[] args) {
		...
		try {
			...
			// System.out.println("El tamaño de " + nifStr + " es de " +
 ...
 * 
 * Usar el método estático isLetter(char c) de java.lang.Character para
 ...
 * 
 * Usar el método substring(int inicio, int fin) de java.lang.String para
