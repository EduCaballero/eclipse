...
public class BatallaNavalApp{
 
    public static void main (String[] args){
        try{
            //BufferedReader buffer = new BufferedReader(new InputStreamReader(System.in));
 
            /*int ampleH = 10;        // Ample horitzontal
            int ampleV = 10;        // Ample vertical
            int numBarcos= 4;       // Número de barcos
            int medidaMinima = 2;   // Mida minima dels barcos
            int numIntentos = 50;    // Número de intentos
            boolean mostrar = true;*/
 
 
            char[][] tablero = new char[ampleV][ampleH];
            int intento = 1;
            int x = 0;
