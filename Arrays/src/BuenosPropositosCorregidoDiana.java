...
public class BuenosPropositosCorregidoDiana {
		...
		try {
			...
			while(opcion != 8){
				...
				case 3:
					Hproduct.clear();
					for(int i = 0; i < 7; i++){
						System.out.println("¿Cuantas horas productivas has tenido el " + dias.get(i));
				...
				case 5:
					...
					System.out.println("El día en que se ha consumido menos ha sido el día " + dias.get(posmin)
					+ "con un total de " + minfrutas + "frutas/verduras" );
					System.out.println("El día en que se ha consumido más ha sido el día " + dias.get(posmax)
				...
				case 7:
					...
					if((!ejer&&!fruta)||(!ejer&&!prod)||(!fruta&&!prod)){
						System.out.println("¡Venga tu puedes!");
					}else{
