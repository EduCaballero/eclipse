...
public static void main(String[] args) {
		...
		try{
		    ...
		    int num = 0; // cada nota se guardará aquí
		    int[] numeros = new int[15]; // array notas
		    int total=0;
		    
		    for(int i=0; i<numeros.length; i++){
		    	System.out.println("Introduzca los datos de la posición " + (i+1)); // con esto hago que me muestre el número del alumno, pero empezando desde el 1, aunque realmente el array se guarde en la posición empezando desde el 0
