		...
		try {
            ...
            while (opt!=4){
				...
				if(opt==3){
					...
					if(supervivientesr>supervivientesi){ganar++; System.out.println("La resistencia tiene más supervivientes");}
					if(supervivientesi>supervivientesr){ganai++; System.out.println("El imperio tiene más supervivientes con ");}
					...
					if(masdefensar>masdefensai){ganar++; System.out.println("La resistencia tiene más defensa");}
					if(masdefensai>masdefensar){ganai++; System.out.println("El imperio tiene más defensa con");}
					...
					if(ganai==ganar)System.out.println("Equilibrada la fuerza está"); //empate
				}
