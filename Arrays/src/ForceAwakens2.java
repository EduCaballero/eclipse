	...
	public static void main(String[] args) {
		try {
            ...
            while (opt!=4){
				...
				System.out.println("3. ANÁLISIS DE LA BATLLA");
				System.out.println("4. SALIR");
				System.out.println();
				
				opt= Integer.parseInt(buffer.readLine());
				
				if(opt==4)System.out.println("QUE LA FUERZA TE ACOMPAÑE");
				...
				if(opt==1){
					...
					System.out.println("La energía de la resistencia es: " + Arrays.toString(eresistencia));
					System.out.println("La defensa del imperio es: " + Arrays.toString(dimperio));
					System.out.println("La energía del imperio es: " + Arrays.toString(eimperio));					
					/*for(int i = 0;i<dresistencia.length;i++){ esto sería para mostrarlo
					...
					if(empieza==0){ //ataca imperio
						...
						for(int i = 0;i<dresistencia.length;i++){
							if (i==0 || i%2==0){//esto es para que turnar los ataques (numeros pares)
								if(eimperio[i]!=0 && eresistencia[i]!=0){ //con esto hago que si cualquiera de los dos tiene 0 energía(muerto) se salte el combate
				...
				if(opt==3){
					...
					System.out.println("La resistencia tiene una energía de " + energiamaxr);
					System.out.println("El imperio tiene una energía de " + energiamaxi);
					if(energiamaxr>energiamaxi)ganar++; System.out.println("La resistencia tiene más energía");
					if(energiamaxi>energiamaxr)ganai++; System.out.println("El imperio tiene más energía");
					if(energiamaxi==energiamaxr)System.out.println("Resistencia e Imperio tienen la misma energía");
					
					for(int i = 0;i<dresistencia.length;i++){
						if(eresistencia[i]>0)supervivientesr++;
						if(eimperio[i]>0)supervivientesi++;
					}
					if(supervivientesr>supervivientesi)ganar++; System.out.println("La resistencia tiene más supervivientes con " + supervivientesr);
					if(supervivientesi>supervivientesr)ganai++; System.out.println("El imperio tiene más supervivientes con " + supervivientesi);
					if(supervivientesr==supervivientesi)System.out.println("Ambos tienen el mismo número de supervivientes");
					
					for(int i = 0;i<dresistencia.length;i++){
						masdefensar+=dresistencia[i];
						masdefensai+=dimperio[i];
					}
					if(masdefensar>masdefensai)ganar++; System.out.println("La resistencia tiene más defensa con " + masdefensar);
					if(masdefensai>masdefensar)ganai++; System.out.println("El imperio tiene más defensa con " + masdefensai);
					if(masdefensar==masdefensai)System.out.println("Ambos tienen el mismo número de defensa");
					...
					System.out.println("La resistencia tiene " + ganai + " puntos");
					if(ganar>ganai)System.out.println("La fuerza prevalece!");
					if(ganai>ganar)System.out.println("El lado oscuro fuerte es");
					if(ganai==ganar)System.out.println("Equilibrada la fuerza está");
				}
