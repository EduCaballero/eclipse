	...
	public static void main(String[] args){
        ...
        try{
            ...
            while(longpista<numerodehormigas){
            	System.out.println("Error. No puede haber más hormigas que posiciones en la pista. ¿Cuántas hormigas hay en la pista?");
                numerodehormigas =Integer.parseInt(buffer.readLine());
            }
            
                for(int i=0;i<numerodehormigas;i++){
                	System.out.println("¿En qué posición quieres hormigas?");
                	z= Integer.parseInt(buffer.readLine());
                	while(posiciones[z-1]==1){
                		System.out.println("Posición ya opcupada.¿En qué posición quieres hormigas?");
                    	z= Integer.parseInt(buffer.readLine());
                	}
                ...
                System.out.println("Las hormigas tardarán un máximo de " + max + " segundos y un mínimo de " + menor + " segundos");
