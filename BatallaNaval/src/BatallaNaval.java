...
public class BatallaNaval {
	...
	public static void main(String[] args) {
		try {
			...
			imprimir(tablero, mostrar); // Esto sólo se muestra de cara a
										// corregir fácilmente o ver que el
										// juego funciona. No debería mostrarse
			...
			} while (intento <= numIntentos && numX < x); // Y después repetimos
															// hasta el intento
															// 50 -que sería el
															// 51-.
