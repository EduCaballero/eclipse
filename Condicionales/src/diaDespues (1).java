...
/* todo sucio, para ver errores de pruebas anteriores
			...
			if (dia<=0 || mes<=0 || dia>31 || mes>12) System.out.println("No puede haber un d’a y/o mes con valor negativo");
			
			else if ((mes==2 && dia==28) || (mes==2 && any%4==0 && any%100!=0 || any % 400 == 0 && dia==29)) { 
				System.out.println("El d’a siguiente al que has introducido es el 1 del 3 del a–o " + any1);
			}
			
			else if ((dia==30 && (mes==4||mes==6||mes==9||mes==11)) || (dia==31 && mes!=12)) {
				System.out.println("El d’a siguiente al que has introducido es el 1 del " + mes1 + " del a–o " + any);
			}
			
			else if (dia==31 && mes==12) {
				System.out.println("El d’a siguiente al que has introducido es el 1 del 1 del a–o " + any1);
			}
				
			else System.out.println("El d’a siguiente al que has introducido es el "+ dia1 + " del " + mes + " del a–o " + any);
