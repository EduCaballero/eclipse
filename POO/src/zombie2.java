public class Zombies {
   ...
   // ArrayList<Integer> Personas_convertidas_anyo = new ArrayList<Integer>();
    ...
    public Zombies(String nombre, int nivel, int[] Personas_convertidas_anyo) {
        this.nombre = nombre;
        this.nivel = nivel;
        this.Personas_convertidas_anyo = Personas_convertidas_anyo;
    }
...
// GETTERS
    ...
    public int[] getPersonas_convertidas_anyo() {
        return Personas_convertidas_anyo;
    }
    
    public int getAnyosZombie() {
        return anyosZombie;
    }
...
// SETTERS
    ...
    public void setPersonas_convertidas_anyo (int[] Personas_convertidas_anyo) {
    	this.Personas_convertidas_anyo = Personas_convertidas_anyo;
    }
    
    public void setAnyosZombie(int anyosZombie) {
        this.anyosZombie = anyosZombie;
    }
...
// METODOS
    ...
    public String mostrarInformacion() {
        int anyo_para_conversion = 5 - getAnyosZombie();

        String mostrar = "Hola " + this.nombre + ", has vivido "
                + getAnyosZombie() + " anyos como zombie, aun te faltan "
