...
public class ClaseStringMetodos {
	...
	public static void main(String[] args) {
		...
		System.out.println("La última letra del nombre es "+nombre.charAt(ultimaLetra-1));
		...
		//también podríamos rizar el rizo:
		...
		System.out.println(alumno1.equals(alumno2));//Esto es true. este método es case sensitive.
