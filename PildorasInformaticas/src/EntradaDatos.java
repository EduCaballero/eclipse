...
public class EntradaDatos {
	...
	//Los métodos de entrada de datos de Scanner no son estáticfos, ergo necesitamos haber creado previamente un objeto clase Scanner.
		//Justo lo que hacemos aquí debajo
		...
		//JOptionPane--------------------------------------
		//Son estáticos, ergo no tendremos que crear un objeto con la clase JOptionPane, es decir, 
		...
		System.out.println("Hola "+ nombreUser2+", tienes "+edad2+" años.");
		
		//Ahora vamos a parsear la edad y transformarla a Int
		int edad2Parseada=Integer.parseInt(edad2);
		//Ahora ya tendremos edad2Parseada como Int y podremos operar con ese número. ej:
		System.out.println("Hola "+ nombreUser2+", tendrás "+(edad2Parseada+1)+" el próximo año.");
