...
public class PrimerasPinceladas {
	 ...
	 * 
	 * Los métodos constructores tienen el mismo nombre que la clase a la que pertenecen.
	 * 
	 ...
	 * //Para formatear los datos, por ejemplo los deciamles, lo podemos hacer así
		...
		System.out.printf("%1.2f", x/3); //con esto sacaríamos 2 decimales. Con "%1.4f" etc
	 *
	 *
	 * 
	 */
