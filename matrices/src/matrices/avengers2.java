...
public class avengers2 {
	public static void main(String[] args) {
		try {
			...
			int ocho = 0;
			String intuicion = "";
			ArrayList<String> intuicion2 = new ArrayList<String>();
			intuicion2.add("IGUAL");
			intuicion2.add("LO MISMO");
					...
					if (opcion1 == true) {
						...
						for (int i = 0; i < ranked.length; i++) {
							System.out.print(nombres.get(i) + " ha quedado en " + df.format(ranked[i][1])
									+ "ª posición con " + df2.format(ranked[i][0]) + " puntos");
							System.out.println();
						}
					} else
						System.out.println("Debes seleccionar la primera opción del menú primero!");
				}
				...
				if (opt == 3) {
					if (opcion1 == true) {
						...
						if (mision < puntostotales) {
							...
							System.out
									.println("Los vengadores que van a ir a la misión y su puntaje son los siguientes");
							System.out
				...
				if (opt == 4) {
					if (opcion1 == true) {
						while (opt4 != 4.6) {
							...
							System.out.println("4.4 Mejorar intuición");
							System.out.println("4.5 Mejorar inmortalidad");
							System.out.println("4.6 Atrás");
							System.out.println();
							...
							if (opt4 == 4.2) {
								...
								if (ocho == 8) {
									if (sel == 1) {
										System.out.println(
												"El Capitán América tenía " + avengers[0][1] + " puntos inteligencia");
										avengers[0][1] += 1;
										System.out.println("Ahora tiene " + avengers[0][1] + " puntos");
									}
									if (sel == 2) {
										System.out.println("Iron Man tenía " + avengers[1][1] + " puntos inteligencia");
										avengers[1][1] += 1;
										System.out.println("Ahora tiene " + avengers[1][1] + " puntos");
									}
									if (sel == 3) {
										System.out.println(
												"La Viuda Negra tenía " + avengers[2][1] + " puntos inteligencia");
										avengers[2][1] += 1;
										System.out.println("Ahora tiene " + avengers[2][1] + " puntos");
									}
									if (sel == 4) {
										System.out.println("Thor tenía " + avengers[3][1] + " puntos inteligencia");
										avengers[3][1] += 1;
							...
							if (opt4 == 4.3) {
								...
								if (sel == 1) {
									System.out.println(
											"El Capitán América tenía " + avengers[0][2] + " puntos velocidad");
									avengers[0][2] += 1;
									System.out.println("Ahora tiene " + avengers[0][2] + " puntos");
								}
								if (sel == 2) {
									System.out.println("Iron Man tenía " + avengers[1][2] + " puntos velocidad");
									avengers[1][2] += 1;
									System.out.println("Ahora tiene " + avengers[1][2] + " puntos");
								}
								if (sel == 3) {
									System.out.println("La Viuda Negra tenía " + avengers[2][2] + " puntos velocidad");
									avengers[2][2] += 1;
									System.out.println("Ahora tiene " + avengers[2][2] + " puntos");
								}
								if (sel == 4) {
									System.out.println("Thor tenía " + avengers[3][2] + " puntos velocidad");
									avengers[3][2] += 1;
							...
							if (opt4 == 4.4) {
								...
								sel = Integer.parseInt(buffer.readLine());
								System.out.println(
										"¿Pesa más un quilo de hierro o un quilo de plumas? Responde EN MAYÚSCULAS");
								intuicion = buffer.readLine();
								
								if (intuicion.equals(intuicion2.get(0)) || intuicion.equals(intuicion2.get(1))) {
									if (sel == 1) {
										System.out.println(
												"El Capitán América tenía " + avengers[0][3] + " puntos intuición");
										avengers[0][3] += 1;
										System.out.println("Ahora tiene " + avengers[0][3] + " puntos");
									}
									if (sel == 2) {
										System.out.println("Iron Man tenía " + avengers[1][3] + " puntos intuición");
										avengers[1][3] += 1;
										System.out.println("Ahora tiene " + avengers[1][3] + " puntos");
									}
									if (sel == 3) {
										System.out.println(
												"La Viuda Negra tenía " + avengers[2][3] + " puntos intuición");
										avengers[2][3] += 1;
										System.out.println("Ahora tiene " + avengers[2][3] + " puntos");
									}
									if (sel == 4) {
										System.out.println("Thor tenía " + avengers[3][3] + " puntos intuición");
										avengers[3][3] += 1;
							...
							if (opt4 == 4.5)
								System.out.println(
										"No es posible mejorar tu inmortalidad. Cuando te llegue el momento deberás aceptarlo");
